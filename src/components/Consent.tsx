...
const Consent = () => {
  ...
  return (
    <div
      className="text-white fixed bottom-0 left-0 right-0 py-8 px-6 flex flex-col md:flex-row justify-between items-center z-10 w-[80%] mx-auto mb-6 border border-black/20 bg-black/80 backdrop-blur-xl rounded-lg shadow-lg"
    >
