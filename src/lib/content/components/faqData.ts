...
const rentalConditionsFaq: FaqItemProps[] = [
  {
    question: "Wie hoch sind die Kosten für die Anlieferung?",
    answer:
      "Die Anlieferungskosten hängen von Maschine und Einsatzort ab. Den genauen Preis erhalten Sie transparent vor der Buchung.",
  },
  {
    question: "Gibt es eine Maschinenbruchversicherung?",
    answer:
      "Ja, es wird eine Maschinenbruchversicherung in Höhe von 10 % der Nettomiete berechnet.",
  },
  {
    question: "Muss die Maschine vollgetankt zurückgegeben werden?",
    answer:
      "Ja, bitte geben Sie die Maschine mit dem vereinbarten Tankstand zurück. Fehlender Kraftstoff wird nachberechnet.",
  },
  // {
  //   question: "Wie viele Betriebsstunden sind inklusive?",
  //   answer:
  //     "Im Mietpreis sind [X] Betriebsstunden pro [Tag/Woche] enthalten. Mehrstunden berechnen wir separat.",
  // },
  {
    question: "Wie sauber muss die Maschine zurückgegeben werden?",
    answer:
      "Eine normale Reinigung reicht aus. Bei starker Verschmutzung behalten wir uns vor, eine Reinigungspauschale zu berechnen.",
  },
  {
    question: "Muss ich eine Kaution hinterlegen?",
    answer:
      "Je nach Maschine kann eine Kaution erforderlich sein. Die genaue Höhe nennen wir Ihnen vor der Buchung.",
  },
];
...
const mannheimFaq: FaqItemProps[] = [
  {
    question:
  ...
  {
    question: "Kann ich bei BAGGER1 auch als Privatkunde Baumaschinen mieten?",
    answer:
...
const bruchsalFaq: FaqItemProps[] = [
  {
    question: "Welche Baumaschinen kann ich bei BAGGER1 in Bruchsal mieten?",
    answer:
  ...
  {
    question: "Wie erkenne ich die Verfügbarkeit von Mietgeräten in Bruchsal?",
    answer:
  ...
  {
    question: "Gibt es in Bruchsal Kurzzeit- und Langzeitmiete bei BAGGER1?",
    answer:
...
const hennefFaq: FaqItemProps[] = [
  {
    question: "Welche Baumaschinen kann ich bei BAGGER1 in Hennef mieten?",
    answer:
  ...
  {
    question: "Welche Mietdauer ist in Hennef möglich – kurz oder langfristig?",
    answer:
